...
虚拟DOM是使用JS对象来表示真实DOM的一种方式。

1. 虚拟DOM是一个JS对象，可以实现跨平台渲染，如浏览器、移动端渲染，服务器渲染等。
2. 由于Vue的更新是组件级别更新的，所以虚拟 DOM 可以实现高效的 DOM diff 算法，只更新需要改变的部分，避免全量更新导致的性能问题。
